...
function Sidebar() {
    ...
    return (
      <>
        ...
        {currentUser && <a href={currentUser.photoURL ||userdata.avatar}> <img src={userdata.avatar ||" https://via.placeholder.com/50" }className="rounded-circle" alt="..." width="50"
 height="50"/></a>}
          </div>
          <nav className={sidebar ? 'nav-menu active' : 'nav-menu'}>
            <ul className='nav-menu-items mt-2' >
              ...
              {!currentUser && <li  className='nav-text' >
                  ...
                  {currentUser && currentUser.uid==="F7POelXiD7f3BSpGwHOyeBeie3l1" && <li  className='nav-text' >
                    <Link to="/admindash">
                      <span>User</span>
